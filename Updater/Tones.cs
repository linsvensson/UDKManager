...
namespace Updater
{
    ...
    public class Tones
    {
        ...
        public static void Parse(string line, out int freq, out int dur)
        {
            ...
            var noteIdx = ParseNote(tokens.First().ToUpper().Trim());
            ...
            freq = tokens.First().ToUpper().Trim() == "P" ? 22000 : GetFreq(noteIdx, octIdx);
        }
